...
type GlobalConfig interface {
	...
	GlobalEthTxLogUnconfirmedAfterThreshold() (time.Duration, bool)
...
func (c *generalConfig) GlobalEthTxLogUnconfirmedAfterThreshold() (time.Duration, bool) {
	return lookupEnv(c, envvar.Name("EthTxLogUnconfirmedAfterThreshold"), time.ParseDuration)
}
